...
export default function ReportFull() {
  ...
  const t = {
    ...
    zh: {
      ...
      autoGenerateDesc: "AI根据租约盾扫描建议创建谈判信件",
      secureTierOnly: "仅限安全层",
      generating: "正在分析扫描并生成...",
      generated: "信件已生成！",
      viewLetters: "查看信件",
      upgradeToSecure: "升级到安全层",
      upgradeDesc: "根据您的租约扫描结果获取AI信件生成",
    ...
    ja: {
      ...
      autoGenerateDesc: "リースシールドスキャン推奨事項に基づいてAIが交渉レターを作成",
      secureTierOnly: "セキュアティアのみ",
      generating: "スキャンを分析して生成中...",
      generated: "レター生成完了！",
      viewLetters: "レターを表示",
      upgradeToSecure: "セキュアにアップグレード",
      upgradeDesc: "賃貸契約スキャン結果に基づくAIレター生成を取得",
    ...
    ko: {
      ...
      autoGenerateDesc: "리스실드 스캔 권장사항을 기반으로 AI가 협상 편지를 생성합니다",
      secureTierOnly: "시큐어 티어 전용",
      generating: "스캔 분석 및 생성 중...",
      generated: "편지 생성 완료!",
      viewLetters: "편지 보기",
      upgradeToSecure: "시큐어로 업그레이드",
      upgradeDesc: "임대 계약 스캔 결과를 기반으로 AI 편지 생성 받기",
