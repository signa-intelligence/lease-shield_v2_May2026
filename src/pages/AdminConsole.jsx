...
import { Users, FileText, Shield, Database, TestTube, Send, Loader2, Settings, Trash2, Ban, CheckCircle, Crown, Coins, Lock, Unlock, DollarSign, TrendingUp, AlertCircle, UserX, UserCheck, Scale, ChevronDown, ChevronUp, MessageCircle, BarChart3 } from "lucide-react";
              ...
              <div className="flex items-center gap-3 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm hidden sm:block" style={{ color: colors.textSecondary }}>
                    View lease scan volumes, risk scores and flag data
                  </p>
                </div>
              </div>
              <Link to={createPageUrl("ScanAnalytics")} className="flex-shrink-0">
                <Button className="bg-emerald-700 hover:bg-emerald-800 w-full sm:w-auto min-h-[44px] px-4">
                  <BarChart3 className="w-4 h-4 sm:mr-2" />
                  <span className="hidden sm:inline">View Scan Analytics</span>
