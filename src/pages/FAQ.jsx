  ...
  general: {
    ...
    questions: [
      ...
      },
      {
        ...
        questionTh: 'เจ้าของบ้านสามารถเก็บเงินมัดจำของฉันในประเทศไทยได้หรือไม่?',
        questionZh: '房东可以在泰国扣留我的押金吗？',
        questionJa: 'タイで家主は敷金を留保できますか？',
        ...
        answerTh: 'ได้ สัญญาหลายฉบับอนุญาตให้หักเงินหากเงื่อนไขไม่ชัดเจนหรือไม่ได้กำหนดไว้',
        answerZh: '是的，许多合同允许在条款不明确或未定义时进行扣除。',
        answerJa: 'はい、条項が不明確または未定義の場合、多くの契約では控除が認められています。',
        answerKo: '예, 많은 계약서에서 조항이 불분명하거나 정의되지 않은 경우 공제를 허용합니다.',
        answerRu: 'Да, многие договоры допускают удержания, если условия неясны или не определены.'
      },
      {
        questionEn: 'Why are Thai and English leases different?',
        questionTh: 'ทำไมสัญญาเช่าภาษาไทยและภาษาอังกฤษจึงแตกต่างกัน?',
        questionZh: '为什么泰文和英文租约不同？',
        questionJa: 'なぜタイ語と英語のリース契約は異なるのですか？',
        questionKo: '태국어와 영어 임대 계약이 다른 이유는 무엇인가요?',
        ...
        answerTh: 'ในหลายกรณี ฉบับภาษาไทยมีผลผูกพันทางกฎหมายและอาจมีเงื่อนไขที่เข้มงวดกว่า',
        answerZh: '在许多情况下，泰文版本具有法律约束力，可能包含更严格的条款。',
        answerJa: '多くの場合、タイ語版が法的拘束力を持ち、より厳しい条件が含まれる場合があります。',
        answerKo: '많은 경우 태국어 버전이 법적 구속력이 있으며 더 엄격한 조건을 포함할 수 있습니다.',
        answerRu: 'Во многих случаях тайская версия является юридически обязательной и может содержать более строгие условия.'
      },
      {
        ...
        answerTh: 'เงื่อนไขที่ซ่อนอยู่ บทลงโทษ และความเสี่ยงที่อาจนำไปสู่การสูญเสียเงินมัดจำ',
        answerZh: '隐藏条款、罚款以及可能导致押金损失的风险。',
        answerJa: '隠れた条項、ペナルティ、および保証金損失につながる可能性のあるリスク。',
        answerKo: '숨겨진 조항, 벌금, 보증금 손실로 이어질 수 있는 위험.',
