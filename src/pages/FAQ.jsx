  ...
  pricing: {
    ...
    questions: [
      ...
      },
      {
        ...
        answerEn: 'Explorer (Free)\n• 1 lifetime scan\n• 100MB storage\n• Basic features\n\nLite\n฿158/month — 17% OFF (paid annually ฿1,900/year) or ฿190/month\n• 6 lease scans/year\n• Email alerts\n• 3 letter credits\n• 1GB storage\n\nProtect\n฿325/month — 17% OFF (paid annually ฿3,900/year) or ฿390/month\n• Everything in Lite\n• 12 scans/year\n• LINE alerts\n• 5 letter credits\n• 5GB storage\n\nSecure\n฿825/month — 17% OFF (paid annually ฿9,900/year) or ฿990/month\n• Everything in Protect\n• Unlimited scans\n• 50 letter credits/month (auto-refreshed every 30 days)\n• 20GB storage\n• 1 Resolve case/year (included)\n• Unlimited FastTrack (complimentary)',
        answerTh: 'Explorer (ฟรี)\n• 1 การสแกน (ตลอดชีพ)\n• พื้นที่ 100MB\n• ฟีเจอร์พื้นฐาน\n\nLite\n฿158/เดือน — ลด 17% (ชำระรายปี ฿1,900/ปี) หรือ ฿190/เดือน\n• 6 การสแกน/ปี\n• อีเมลแจ้งเตือน\n• 3 เครดิตจดหมาย\n• พื้นที่ 1GB\n\nProtect\n฿325/เดือน — ลด 17% (ชำระรายปี ฿3,900/ปี) หรือ ฿390/เดือน\n• ทุกอย่างใน Lite\n• 12 การสแกน/ปี\n• LINE แจ้งเตือน\n• 5 เครดิตจดหมาย\n• พื้นที่ 5GB\n\nSecure\n฿825/เดือน — ลด 17% (ชำระรายปี ฿9,900/ปี) หรือ ฿990/เดือน\n• ทุกอย่างใน Protect\n• สแกนไม่จำกัด\n• 50 เครดิตจดหมาย/เดือน (เติมอัตโนมัติทุก 30 วัน)\n• พื้นที่ 20GB\n• 1 คดี Resolve/ปี (รวม)\n• FastTrack ไม่จำกัด (ฟรี)',
        answerZh: 'Explorer（免费）\n• 1次终身扫描\n• 100MB存储\n• 基本功能\n\nLite\n฿158/月 — 17% 折扣（按年支付 ฿1,900/年）或 ฿190/月\n• 每年6次租约扫描\n• 电子邮件提醒\n• 3个信件积分\n• 1GB存储\n\nProtect\n฿325/月 — 17% 折扣（按年支付 ฿3,900/年）或 ฿390/月\n• Lite所有功能\n• 每年12次扫描\n• LINE提醒\n• 5个信件积分\n• 5GB存储\n\nSecure\n฿825/月 — 17% 折扣（按年支付 ฿9,900/年）或 ฿990/月\n• Protect所有功能\n• 无限扫描\n• 每月50个信件积分（每30天自动刷新）\n• 20GB存储\n• 每年1个Resolve案件（包含）\n• 无限FastTrack（免费）',
        answerJa: 'Explorer（無料）\n• 1回生涯スキャン\n• 100MBストレージ\n• 基本機能\n\nLite\n฿158/月 — 17% OFF（年払い ฿1,900/年）または ฿190/月\n• 年6回リーススキャン\n• メールアラート\n• 3レタークレジット\n• 1GBストレージ\n\nProtect\n฿325/月 — 17% OFF（年払い ฿3,900/年）または ฿390/月\n• Liteの全機能\n• 年12回スキャン\n• LINE通知\n• 5レタークレジット\n• 5GBストレージ\n\nSecure\n฿825/月 — 17% OFF（年払い ฿9,900/年）または ฿990/月\n• Protectの全機能\n• 無制限スキャン\n• 月50レタークレジット（30日ごとに自動更新）\n• 20GBストレージ\n• 年1件Resolveケース（含）\n• 無制限FastTrack（無料）',
        answerKo: 'Explorer（무료）\n• 1회 평생 스캔\n• 100MB 저장소\n• 기본 기능\n\nLite\n฿158/월 — 17% OFF（연간 결제 ฿1,900/년）또는 ฿190/월\n• 연간 6회 임대 계약 스캔\n• 이메일 알림\n• 3개 레터 크레딧\n• 1GB 저장소\n\nProtect\n฿325/월 — 17% OFF（연간 결제 ฿3,900/년）또는 ฿390/월\n• Lite 모든 기능\n• 연간 12회 스캔\n• LINE 알림\n• 5개 레터 크레딧\n• 5GB 저장소\n\nSecure\n฿825/월 — 17% OFF（연간 결제 ฿9,900/년）또는 ฿990/월\n• Protect 모든 기능\n• 무제한 스캔\n• 월 50개 레터 크레딧（30일마다 자동 갱신）\n• 20GB 저장소\n• 연간 1건 Resolve 케이스（포함）\n• 무제한 FastTrack（무료）',
        answerRu: 'Explorer（Бесплатно）\n• 1 сканирование навсегда\n• 100MB хранилище\n• Базовые функции\n\nLite\n฿158/месяц — 17% OFF（годовая оплата ฿1,900/год）или ฿190/месяц\n• 6 сканирований договора/год\n• Email-уведомления\n• 3 кредита писем\n• 1GB хранилище\n\nProtect\n฿325/месяц — 17% OFF（годовая оплата ฿3,900/год）или ฿390/месяц\n• Всё из Lite\n• 12 сканирований/год\n• LINE-уведомления\n• 5 кредитов писем\n• 5GB хранилище\n\nSecure\n฿825/месяц — 17% OFF（годовая оплата ฿9,900/год）или ฿990/месяц\n• Всё из Protect\n• Безлимит сканирований\n• 50 кредитов писем/месяц（автообновление каждые 30 дней）\n• 20GB хранилище\n• 1 дело Resolve/год（включено）\n• Безлимит FastTrack（бесплатно）'
      },
      {
