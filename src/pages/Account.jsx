...
import UserLineSection from "../components/settings/UserLineSection";
  ...
  return (
    <div className="min-h-screen p-4 md:p-6 pb-36 md:pb-40 lg:pb-16 page-transition" style={{ backgroundColor: colors.bg }}>
      <div className="max-w-7xl mx-auto">
        ...
        <UserLineSection
          user={user} colors={colors} isDarkMode={isDarkMode} language={language}
          toast={toast} onOpenLineModal={setShowLineModal}
          refetchUser={refetchUser} queryClient={queryClient}
        />
