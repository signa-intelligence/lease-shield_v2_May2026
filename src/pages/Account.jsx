...
const PLAN_DETAILS = [
  ...
  },
  {
    ...
    benefits: [
      ...
      '50 Lease Scans/year (max 10/mo)', '50 Letter Credits/year (max 10/mo)',
      ...
      '10 FastTrack/year (max 3/mo)'
    ],
    benefitsTh: [
      'ทุกอย่างในแผน Protect',
      '50 สแกน/ปี (สูงสุด 10/เดือน)', '50 เครดิตจดหมาย/ปี (สูงสุด 10/เดือน)',
      'พื้นที่จัดเก็บ 20GB',
      'ติดตามเงินมัดจำ',
      ...
      'การสนับสนุนพรีเมียม',
      '1 คดี Resolve ต่อปี',
      '10 FastTrack/ปี (สูงสุด 3/เดือน)'
    ],
    benefitsRu: [
      'Все из тарифа Protect',
      '50 сканирований/год (макс. 10/мес.)', '50 кредитов/год (макс. 10/мес.)',
      ...
      '10 FastTrack/год (макс. 3/мес.)'
    ],
    benefitsZh: [
      '包含Protect计划所有内容',
      '每年50次扫描（月最多10次）', '每年50信件积分（月最多10次）',
      '20GB文档存储',
      '押金追踪器',
      '优先案件队列',
      '优先扫描',
    ...
    benefitsKo: [
      'Protect 플랜의 모든 내용',
      '연50회 스캔（월 최대 10회）', '연50 레터 크레딧（월 최대 10회）',
      '20GB 문서 저장소',
      '보증금 추적기',
      '우선 사례 대기열',
      '우선 스캔',
...
function AccountContent() {
  ...
  const t = {
    ...
    zh: {
      ...
      secureFeatures: "每年50次扫描，优先支持和每年50个信件积分",
    ...
    ja: {
      ...
      secureFeatures: "年50回スキャン、優先サポート、年50レタークレジット",
    ...
    ko: {
      ...
      secureFeatures: "연 50회 스캔, 우선 지원 및 연 50개 레터 크레딧",
    ...
    ru: {
      ...
      secureFeatures: "50 сканирований/год, приоритетная поддержка и 50 кредитов/год",
