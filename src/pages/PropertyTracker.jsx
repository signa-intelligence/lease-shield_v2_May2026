              ...
              <CardContent className="p-6">
                {(!deposit?.rent_amount || !deposit?.rent_due_day) && !editingRent ? (
                  ...
                  <div className="space-y-4">
                    ...
                    {deposit?.rent_amount > 0 && deposit?.rent_due_day && (
                      <RentPaymentTracker deposit={deposit} colors={colors} isDarkMode={isDarkMode} language={language} toast={toast} user={user} />
                    )}
                  </div>
                )}
              </CardContent>
