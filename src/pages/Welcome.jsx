...
export default function Welcome() {
  ...
  const t = {
    en: {
      ...
      continueCaption: "Google sign-in opens a secure browser window and returns to LeaseShield automatically.",
    ...
    th: {
      ...
      continueCaption: "การลงชื่อเข้าใช้ Google จะเปิดหน้าต่างเบราว์เซอร์ที่ปลอดภัยและกลับมายัง LeaseShield โดยอัตโนมัติ",
    ...
    ru: {
      ...
      continueCaption: "Вход через Google откроет безопасное окно браузера и автоматически вернёт вас в LeaseShield.",
