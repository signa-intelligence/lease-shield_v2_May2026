...
function AnalyticsContent() {
  ...
  const t = {
    ...
    ru: {
      ...
      subtitle: "Отслеживайте ваш путь защиты аренды",
      back: "Назад",
      timeRange: "Временной диапазон",
      last1Month: "Прошлый месяц",
      last3Months: "Последние 3 месяца",
      last6Months: "Последние 6 месяцев",
      lastYear: "Прошлый год",
      allTime: "Всё время",
      totalProtected: "Всего защищено",
      totalDeposits: "Всего депозитов",
      activeCases: "Активные дела",
      avgReturnTime: "Ср. время возврата",
      days: "дней",
      documentsStored: "Сохранено документов",
      files: "файлов",
      depositTrend: "Тренд отслеживания депозитов",
      caseSuccessRate: "Успешность дел",
      documentGrowth: "Рост загрузки документов",
      monthlyActivity: "Месячная активность",
      casesByType: "Дела по типам",
      casesByStatus: "Дела по статусам",
      depositsByStatus: "Депозиты по статусам",
      keyMetrics: "Ключевые метрики",
      successRate: "Уровень успеха",
      resolved: "разрешено",
      avgResolutionTime: "Ср. время разрешения",
      totalRecovered: "Всего возвращено",
      protectionScore: "Уровень защиты",
      noDataYet: "Данных пока недостаточно",
      uploadMore: "Загрузите больше документов и отслеживайте депозиты для получения инсайтов",
      exportReport: "Экспорт PDF отчёта",
      ...
      firstLease: "Первый договор загружен",
      firstDeposit: "Отслеживание депозита начато",
      firstCase: "Первое дело открыто",
      documentCollector: "Коллекционер документов",
      proactiveUser: "Проактивный пользователь",
      upcomingDeadlines: "Предстоящие сроки",
      riskInsights: "Инсайты по рискам",
      next30Days: "Следующие 30 дней",
      depositReturns: "Возврат депозитов",
      leaseNotices: "Уведомления по аренде",
      maintenanceActive: "Активное обслуживание",
      requests: "запросов",
      noUpcoming: "Нет предстоящих сроков",
      allOnTrack: "Всё в порядке！",
      refreshed: "Обновлено успешно",
      exportSuccess: "Отчёт экспортирован успешно",
      exportFailed: "Экспорт не удался",
      highRiskDeposits: "Высокорисковые депозиты",
