...
function ResolveCaseContent() {
  ...
  const strings = {
    en: {
      ...
      templateLetters: "Customised template letters",
    ...
    th: {
      ...
      templateLetters: "จดหมายตัวอย่างที่ปรับแต่ง",
    ...
    ja: {
      ...
      templateLetters: "カスタマイズされたテンプレートレター",
      memberSince: "会員登録日",
    ...
    ru: {
      ...
      templateLetters: "Индивидуально подготовленные шаблоны писем",
