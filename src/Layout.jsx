  ...
  return (
    ...
    <div style={{ 
      ...
      <meta 
        ...
        content="default-src 'self'; script-src 'self' https://js.stripe.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https: blob:; font-src 'self' data:; connect-src 'self' https://qtrypzzcjebvfcihiynt.supabase.co https://api.stripe.com https://api.resend.com https://<my-api-domain>; frame-src https://checkout.stripe.com;" 
      />
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-2 sm:py-3 flex items-center justify-between">
          <div className="flex items-center gap-3 sm:gap-4 min-w-0">
            <Link to="/" className="flex items-center gap-2">
              ...
              {/* Desktop: Horizontal */}
              <span className="hidden lg:inline font-bold text-lg whitespace-nowrap" style={{ color: isDarkMode ? '#F9FAFB' : '#0C3B2E' }}>LEASE SHIELD</span>
            </Link>
            {isAdmin && (
