...
export default function ReferralCard({ user, colors, language = 'en' }) {
  ...
  const t = {
    en: {
      ...
      creditRule: "Credit = Cheaper Plan",
      creditRuleDesc: "You get min(your plan, friend's plan)",
      ...
      example: "Example: You're on Lite (฿190). Friend joins Protect (฿390). You earn ฿190.",
      earnedCredit: "Earned",
      status: "Status"
    },
    th: {
      ...
      creditRule: "เครดิต = แผนที่ถูกกว่า",
      creditRuleDesc: "คุณได้รับ min(แผนของคุณ, แผนเพื่อน)",
      ...
      example: "ตัวอย่าง: คุณใช้ Lite (฿190) เพื่อนใช้ Protect (฿390) คุณได้ ฿190",
      earnedCredit: "ได้รับ",
      status: "สถานะ"
    },
    zh: {
      ...
      creditRule: "额度 = 较低价计划",
      creditRuleDesc: "您获得 min(您的计划，好友计划)",
      autoApplied: "自动应用",
      ...
      example: "示例：您使用Lite（฿190）。好友使用Protect（฿390）。您赚取฿190。",
      earnedCredit: "获得",
      status: "状态"
    },
    ja: {
      ...
      creditRule: "クレジット = 安いプラン",
      creditRuleDesc: "min(あなたのプラン、友達のプラン)を獲得",
      autoApplied: "自動適用",
      ...
      example: "例：あなたはLite（฿190）。友達がProtect（฿390）に参加。あなたは฿190獲得。",
      earnedCredit: "獲得",
      status: "ステータス"
    },
    ko: {
      ...
      creditRule: "크레딧 = 저렴한 플랜",
      creditRuleDesc: "min(귀하의 플랜, 친구 플랜) 획득",
      autoApplied: "자동 적용",
      ...
      example: "예: 귀하는 Lite（฿190）. 친구가 Protect（฿390）가입. 귀하는 ฿190 획득.",
      earnedCredit: "획득",
      status: "상태"
    },
    ru: {
      ...
      creditRule: "Кредит = Дешёвый план",
      creditRuleDesc: "Вы получаете min(ваш план, план друга)",
      ...
      example: "Пример: Вы на Lite (฿190). Друг на Protect (฿390). Вы получаете ฿190.",
