...
export default function NotificationPreferences({ user, onUpdate, colors }) {
  ...
  const strings = {
    ...
    ru: {
      ...
      subtitle: 'Управляйте тем, какие уведомления и когда вы получаете',
      channels: 'Каналы уведомлений',
      email: 'Email уведомления',
      line: 'LINE уведомления',
      types: 'Типы уведомлений',
      depositAlerts: 'Уведомления о возврате депозита',
      deposit30d: 'За 30 дней до возврата',
      deposit7d: 'За 7 дней до возврата',
      deposit3d: 'За 3 дня до возврата',
      depositOverdue: 'Уведомления о просрочке',
      leaseNotices: 'Уведомления об окончании договора',
      lease30d: 'За 30 дней до срока',
      lease7d: 'За 7 дней до срока',
      lease3d: 'За 3 дня до срока',
      lease0d: 'В день срока',
      rentReminders: 'Напоминания об оплате аренды',
      rentReminderDesc: 'Перед сроком оплаты',
      maintenanceUpdates: 'Обновления обслуживания',
      ...
      quietHoursDesc: 'Приостановить уведомления в эти часы',
      enable: 'Включить',
      ...
      saving: 'Сохранение...',
      allEnabled: 'Все уведомления включены',
      someDisabled: 'Некоторые уведомления отключены',
      lineNotConnected: 'Подключите LINE для мгновенных уведомлений',
      connectLine: 'Подключить LINE',
      premiumFeature: 'Премиум функция',
      requiresPremium: 'Доступно в планах Protect и Secure'
    }
  };
