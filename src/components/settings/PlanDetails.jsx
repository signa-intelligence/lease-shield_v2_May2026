...
export const PLAN_DETAILS = [
  {
    ...
    benefitsTh: ['เข้าถึงตลอดชีพ', '1 การสแกนสัญญาเช่า', 'พื้นที่จัดเก็บ Evidence Vault', 'ผู้ช่วย AI Lisa', 'เข้าถึงเทมเพลตเอกสารเช่า', 'บริการ Resolve (฿5,000 ต่อเคส)'],
    benefitsRu: ['Пожизненный доступ', '1 сканирование договора', 'Хранилище Evidence Vault', 'AI-ассистент Lisa', 'Доступ к шаблонам документов аренды', 'Сервис Resolve (฿5 000 за дело)'],
    benefitsZh: ['终身访问', '1次租约扫描', 'Evidence Vault 存储', 'Lisa AI 助手', '访问租赁文件模板', 'Resolve 服务（每案 ฿5,000）'],
    benefitsJa: ['生涯アクセス', '1回のリーススキャン', 'Evidence Vault ストレージ', 'Lisa AIアシスタント', '賃貸書類テンプレートへのアクセス', 'Resolveサービス（1件あたり ฿5,000）'],
    benefitsKo: ['평생 이용', '1회 임대 계약 스캔', 'Evidence Vault 저장소', 'Lisa AI 어시스턴트', '임대 문서 템플릿 이용', 'Resolve 서비스 (건당 ฿5,000)'],
    bgColor: '#64748b',
    icon: Gift
  },
  {
