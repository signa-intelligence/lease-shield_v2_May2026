  ...
  const t = {
    en: {
      ...
      tasks: {
        ...
        verifyDepositDesc: "Never pay a deposit directly to an agent without a receipt that names the landlord as the beneficiary. Agents may pocket deposits before the landlord is aware. Always confirm deposit goes directly to the property owner.",
    ...
    th: {
      ...
      tasks: {
        ...
        verifyDepositDesc: "อย่าจ่ายเงินมัดจำให้ตัวแทนโดยตรงโดยไม่มีใบเสร็จที่ระบุชื่อเจ้าของบ้านเป็นผู้รับเงิน ตัวแทนอาจยักยอกเงินมัดจำก่อนที่เจ้าของบ้านจะรู้ ยืนยันเสมอว่าเงินมัดจำไปถึงเจ้าของทรัพย์สินโดยตรง",
    ...
    zh: {
      ...
      tasks: {
        ...
        verifyDepositDesc: "切勿在没有注明房东为受益人的收据的情况下直接向中介支付押金。中介可能在房东不知情的情况下私吞押金。务必确认押金直接支付给房产所有者。",
    ...
    ja: {
      ...
      tasks: {
        ...
        verifyDepositDesc: "大家が受取人として記載された領収書なしに、仲介業者に直接敷金を支払わないでください。仲介業者は大家が気づく前に敷金を着服する可能性があります。敷金が物件オーナーに直接届くことを必ず確認してください。",
    ...
    ko: {
      ...
      tasks: {
        ...
        verifyDepositDesc: "집주인이 수혜자로 명시된 영수증 없이 중개인에게 직접 보증금을 지불하지 마세요. 중개인은 집주인이 알기 전에 보증금을 횡령할 수 있습니다. 보증금이 부동산 소유자에게 직접 전달되는지 항상 확인하세요.",
    ...
    ru: {
      ...
      tasks: {
        ...
        verifyDepositDesc: "Никогда не платите залог напрямую агенту без квитанции, в которой арендодатель указан как получатель. Агенты могут присвоить залог до того, как арендодатель узнает. Всегда подтверждайте, что залог поступает непосредственно владельцу недвижимости.",
