...
export default function QuickGuide({ user, onDismiss, colors, language = 'en', isOpen, onClose }) {
  ...
  const t = {
    en: {
      ...
      step5Desc: 'Get help from Lisa, your Lease Shield consultant, or access guidance and FAQs anytime.',
      next: 'Next',
      back: 'Back',
      finish: 'Get Started',
    ...
    th: {
      ...
      step5Desc: 'รับความช่วยเหลือจาก Lisa ที่ปรึกษา Lease Shield ของคุณ หรือเข้าถึงคำแนะนำและ FAQ ได้ทุกเมื่อ',
      next: 'ถัดไป',
      back: 'ก่อนหน้า',
      finish: 'เริ่มใช้งาน',
    ...
    zh: {
      ...
      step5: '24/7 协助',
      step5Desc: '从Lisa（您的Lease Shield顾问）获得帮助，或随时访问指导和FAQ',
      next: '下一步',
      back: '上一步',
      finish: '开始使用',
      dontShowAgain: '不再显示'
    ...
    ja: {
      ...
      step5: '24時間365日のサポート',
      step5Desc: 'Lisa（Lease Shieldコンサルタント）からヘルプを受けるか、いつでもガイダンスとFAQにアクセス',
      next: '次へ',
      back: '戻る',
      finish: '始める',
    ...
    ko: {
      ...
      step5: '24/7 지원',
      step5Desc: 'Lisa(Lease Shield 컨설턴트)로부터 도움을 받거나 언제든지 안내 및 FAQ에 액세스',
      next: '다음',
      back: '이전',
      finish: '시작하기',
    ...
    ru: {
      ...
      step5: 'Помощь 24/7',
      step5Desc: 'Получайте помощь от Lisa, вашего консультанта Lease Shield, или получайте доступ к руководству и FAQ в любое время',
      next: 'Далее',
      back: 'Назад',
      finish: 'Начать',
