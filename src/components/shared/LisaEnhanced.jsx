...
- Upgrade path: Explorer → Lite (฿158/mo) → Protect (฿325/mo) → Secure (฿825/mo)
        ...
        {isLoadingHistory ? (
          ...
          <div className="text-center" style={{ marginTop: '60px' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', justifyContent: 'center', marginTop: '16px', padding: '0 12px' }}>
              {[
                { en: 'Check my lease risk', th: 'ตรวจสอบความเสี่ยงสัญญาเช่า', zh: '检查我的租约风险', ja: '契約リスクを確認', ko: '계약 위험 확인', ru: 'Проверить риски договора' },
                { en: 'Can I lose my deposit?', th: 'ฉันอาจเสียเงินมัดจำไหม?', zh: '我会失去押金吗？', ja: '保証金を失う可能性は？', ko: '보증금을 잃을 수 있나요?', ru: 'Могу ли я потерять депозит?' },
                { en: 'Explain this clause', th: 'อธิบายข้อสัญญานี้', zh: '解释这个条款', ja: 'この条項を説明して', ko: '이 조항을 설명해 주세요', ru: 'Объясните это условие' },
                { en: 'Is this contract safe?', th: 'สัญญานี้ปลอดภัยไหม?', zh: '这份合同安全吗？', ja: 'この契約は安全？', ko: '이 계약은 안전한가요?', ru: 'Безопасен ли этот договор?' }
              ].map((suggestion, idx) => (
                <button
                  key={idx}
                  ...
                  style={{
                    ...
                    color: isDarkMode ? '#D1FAE5' : '#0C3B2E',
