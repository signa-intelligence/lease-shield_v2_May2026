...
/**
 * materializeReportV2.js
 * v2.0 - Fresh deployment slug 2026-01-05
 * 
...
Deno.serve(async (req) => {
  ...
  const log = (step, data) => {
    console.log(`[materializeReportV2][${requestId}][${scanId}] ${step}:`, JSON.stringify(data));
  };
  ...
  try {
    ...
    const fallbackPdfPayload = {
      ...
      fallback: true,
      fallback_reason: 'materializeReportV2',
      materialized_at: new Date().toISOString()
    };
