...
<body>
  <div class="header">
    ...
    <div class="info-badge">
      📦 Multi-Language Pack: ${languagePack.allLanguages.map(l => l.toUpperCase()).join(', ')}
    </div>
    <div class="info-badge">
...
${languageSections}
  ...
  <div class="footer">
    ...
    <p>Multi-language letter pack for ${recipientType} - ${languagePack.allLanguages.length} languages included</p>
    <p style="margin-top: 10px; font-size: 11px; color: #94a3b8;">This letter is AI-assisted and human-reviewed. Please verify all details before sending.</p>
  </div>
</body>
</html>`;
