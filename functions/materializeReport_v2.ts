...
/**
 * materializeReport_v2.js
 * v2.0 - Fresh slug deployment 2026-01-05
 * 
...
Deno.serve(async (req) => {
  ...
  const log = (step, data) => {
    console.log(`[materializeReport_v2][${requestId}][${scanId}] ${step}:`, JSON.stringify(data));
  };
  ...
  try {
    ...
    const fallbackPdfPayload = {
      ...
      fallback: true,
      fallback_reason: 'materializeReport_v2',
      materialized_at: new Date().toISOString()
    };
